"""
Downstream task: SIDER: Database of marketed drugs and adverse drug reactions (ADR), grouped into 27 system organ classes.
...
def parse_args():
    ...
    # directory arguments
    parser.add_argument('--output_dir', default='result/SIDER', type=str, help="output directory of task")
    ...
    parser.add_argument('--num_tasks', default=27, type=int, help="number of tasks")
...
def process_data():
    tasks, datasets, transformer = dc.molnet.load_sider(data_dir='../data/MoleculeNet', save_dir='../data/MoleculeNet',
