"""
Downstream task: ToxCast: Toxicology data for a large library of compounds based on in vitro high-throughput screening, including experiments on over 600 tasks
...
def parse_args():
    ...
    # directory arguments
    parser.add_argument('--output_dir', default='result/ToxCast', type=str, help="output directory of task")
    ...
    parser.add_argument('--num_tasks', default=617, type=int, help="number of tasks")
...
def process_data():
    tasks, datasets, transformer = dc.molnet.load_toxcast(data_dir='../data/MoleculeNet', save_dir='../data/MoleculeNet',
