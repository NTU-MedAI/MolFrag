"""
Downstream task: BBBP: Binary labels of blood-brain barrier penetration(permeability)
...
def parse_args():
    ...
    # directory arguments
    parser.add_argument('--output_dir', default='result/BBBP', type=str, help="output directory of task")
...
def process_data():
    tasks, datasets, transformer = dc.molnet.load_bbbp(data_dir='../data/MoleculeNet', save_dir='../data/MoleculeNet',
