"""
Downstream task: ClinTox: Qualitative data of drugs approved by the FDA and those that have failed clinical trials for toxicity reasons
...
def parse_args():
    ...
    # directory arguments
    parser.add_argument('--output_dir', default='result/ClinTox', type=str, help="output directory of task")
...
def process_data():
    tasks, datasets, transformer = dc.molnet.load_clintox(data_dir='../data/MoleculeNet', save_dir='../data/MoleculeNet',
